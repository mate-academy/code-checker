...
const node_fetch_1 = __importStar(__nccwpck_require2_(467));
if (!global.fetch) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__nccwpck_require2_(681);
const process = __importStar(__nccwpck_require2_(765));
const dotenv_1 = __importDefault(__nccwpck_require2_(437));
const chat_1 = __nccwpck_require2_(365);
dotenv_1.default.config();
(() => __awaiter(void 0, void 0, void 0, function* () {
    const chat = new chat_1.Chat(process.env.OPENAI_API_KEY);
    yield chat.codeReview('console.log(hello world);');
}))();
...
var src = __nccwpck_require2_(531);
...
var dist = __nccwpck_require2_(201);
...
var tiktoken = __nccwpck_require2_(14);
...
var _v = _interopRequireDefault(__nccwpck_require2_(1));

var _v2 = _interopRequireDefault(__nccwpck_require2_(632));

var _v3 = _interopRequireDefault(__nccwpck_require2_(881));

var _v4 = _interopRequireDefault(__nccwpck_require2_(307));

var _nil = _interopRequireDefault(__nccwpck_require2_(518));

var _version = _interopRequireDefault(__nccwpck_require2_(743));

var _validate = _interopRequireDefault(__nccwpck_require2_(558));

var _stringify = _interopRequireDefault(__nccwpck_require2_(858));

var _parse = _interopRequireDefault(__nccwpck_require2_(490));
...
var _crypto = _interopRequireDefault(__nccwpck_require2_(417));
...
var _rng = _interopRequireDefault(__nccwpck_require2_(548));

var _stringify = __nccwpck_require2_(858);
...
var _v = _interopRequireDefault(__nccwpck_require2_(829));

var _md = _interopRequireDefault(__nccwpck_require2_(107));
...
var _native = _interopRequireDefault(__nccwpck_require2_(381));
...
var _sha = _interopRequireDefault(__nccwpck_require2_(203));
...
var _regex = _interopRequireDefault(__nccwpck_require2_(987));
...
const packageJson = __nccwpck_require2_(306)
...
const EventEmitter = __nccwpck_require2_(614);
const JSONB = __nccwpck_require2_(820);
...
var Stream = _interopDefault(__nccwpck_require2_(413));
var http = _interopDefault(__nccwpck_require2_(605));
var Url = _interopDefault(__nccwpck_require2_(835));
var whatwgUrl = _interopDefault(__nccwpck_require2_(323));
var https = _interopDefault(__nccwpck_require2_(211));
var zlib = _interopDefault(__nccwpck_require2_(761));
...
let convert;
try {
	convert = __nccwpck_require2_(877).convert;
} catch (e) {}
...
var punycode = __nccwpck_require2_(213);
var mappingTable = __nccwpck_require2_(661);
...
const conversions = __nccwpck_require2_(871);
const utils = __nccwpck_require2_(276);
const Impl = __nccwpck_require2_(262);
...
const punycode = __nccwpck_require2_(213);
const tr46 = __nccwpck_require2_(299);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Chat = void 0;
const chatgpt_1 = __nccwpck_require2_(564);
class Chat {
    constructor(apikey) {
    ...
    `;
        ...
        this.codeReview = (patch) => __awaiter(this, void 0, void 0, function* () {
            if (!patch) {
                return '';
            }
            console.time('code-review cost');
            const prompt = this.generatePrompt(patch);
            const res = yield this.chatAPI.sendMessage(prompt);
...
var __webpack_unused_export__;
const wasm = __nccwpck_require2_(43);
let imports = {};
imports["./tiktoken_bg.js"] = wasm;
const path = __nccwpck_require2_(622).join(__dirname, "tiktoken_bg.wasm");
const bytes = __nccwpck_require2_(747).readFileSync(path);
...
const lTextEncoder = typeof TextEncoder === 'undefined' ? (0, __nccwpck_require__(845))('util').TextEncoder : TextEncoder;
...
const lTextDecoder = typeof TextDecoder === 'undefined' ? (0, __nccwpck_require__(845))('util').TextDecoder : TextDecoder;
...
"use strict";
module.exports = JSON.parse('{"name":"@mate-academy/code-checker","version":"0.0.0","private":true,"description":"TypeScript template action","main":"lib/index.js","scripts":{"build":"tsc","lint":"eslint src/**/*.ts","package":"ncc build --source-map --license licenses.txt","test":"jest","all":"npm run build && npm run lint && npm run package && npm test"},"repository":{"type":"git","url":"git+https://github.com/actions/typescript-action.git"},"keywords":["actions","node","setup"],"author":"","license":"MIT","dependencies":{"@actions/core":"^1.10.0","chatgpt":"^5.1.2","dotenv":"^16.0.3","node-fetch":"^2.6.9","probot":"^12.3.0"},"engines":{"node":"16.x"},"devDependencies":{"@mate-academy/eslint-config-internal":"^1.1.0","@mate-academy/ts-config":"^1.0.5","@types/node":"^18.11.0","@types/node-fetch":"^2.6.2","@typescript-eslint/parser":"^4.33.0","@vercel/ncc":"^0.31.1","eslint":"^7.32.0","eslint-plugin-github":"^4.3.2","eslint-plugin-jest":"^25.3.2","jest":"^27.2.5","js-yaml":"^4.1.0","ts-jest":"^27.1.2","typescript":"^4.4.4"}}');
...
/******/ 	var __webpack_exports__ = __nccwpck_require2_(822);
...
const chat_1 = __nccwpck_require__(365);
dotenv_1.default.config();
(() => __awaiter(void 0, void 0, void 0, function* () {
    const chat = new chat_1.Chat(process.env.OPENAI_API_KEY);
    yield chat.codeReview('console.log(hello world);');
...
var dist = __nccwpck_require__(283);
;// CONCATENATED MODULE: ./node_modules/chatgpt/node_modules/uuid/wrapper.mjs
...
// EXTERNAL MODULE: ./node_modules/@dqbd/tiktoken/tiktoken.cjs
var tiktoken = __nccwpck_require__(14);
;// CONCATENATED MODULE: ./node_modules/eventsource-parser/dist/index.mjs
function createParser(onParse) {
  let isFirstChunk;
  let buffer;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Chat = void 0;
const chatgpt_1 = __nccwpck_require__(564);
class Chat {
    constructor(apikey) {
        this.generatePrompt = (patch) => {
            const answerLanguage = process.env.LANGUAGE
...
var __webpack_unused_export__;
const wasm = __nccwpck_require__(43);
let imports = {};
imports["./tiktoken_bg.js"] = wasm;
const path = __nccwpck_require__(622).join(__dirname, "tiktoken_bg.wasm");
const bytes = __nccwpck_require__(747).readFileSync(path);
const wasmModule = new WebAssembly.Module(bytes);
const wasmInstance = new WebAssembly.Instance(wasmModule, imports);
wasm.__wbg_set_wasm(wasmInstance.exports);
exports.iw = wasm["get_encoding"];
