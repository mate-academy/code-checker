...
export const robot = (app) => {
    ...
    app.on(['pull_request.opened', 'pull_request.synchronize'], async (context) => {
        ...
        if (context.payload.action === 'synchronize' && commits.length >= 2) {
            ...
            const filesNames = (files === null || files === void 0 ? void 0 : files.map((file) => file.filename)) || [];
            changedFiles = changedFiles === null || changedFiles === void 0 ? void 0 : changedFiles.filter((file) => filesNames.includes(file.filename));
        }
        ...
        for (let i = 0; i < changedFiles.length; i++) {
            ...
            const res = await (chat === null || chat === void 0 ? void 0 : chat.codeReview(patch));
            if (res) {
